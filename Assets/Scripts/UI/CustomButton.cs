...
namespace UI
{
    public class CustomButton : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler,
        IPointerUpHandler
    {
        [Header("Custom Button Settings")] [SerializeField]
        ...
        public void OnPointerDown(PointerEventData eventData)
        {
            ...
            HoverImage.sprite = PressedHoverOutlineSprite;
            if (ButtonContent)
                ButtonContent.anchoredPosition = new Vector2(_defaultContentPosition.x,
                    _defaultContentPosition.y + PressedContentOffsetY);
            Image.sprite = PressedSprite;
        }
